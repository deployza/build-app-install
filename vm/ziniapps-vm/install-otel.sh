...
# -----------------------------------------------------------------------------
# vm/ziniapps-vm/install-otel.sh — install this folder's collector config, otel.yaml.
#
#   sudo bash vm/ziniapps-vm/install-otel.sh [--inert]    install it
#   bash vm/ziniapps-vm/install-otel.sh --check            validate only, touch nothing
#
