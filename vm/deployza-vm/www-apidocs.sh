...
# Installed by build-ops/vm/deployza-vm/${APP_NAME}.sh (install_docs_refresh_service).
...
# (build-ops/vm/deployza-vm/${APP_NAME}.sh) for the grant this depends on.
fetch_github_pat() {
...
# Installed by build-ops/vm/deployza-vm/${APP_NAME}.sh. Do not edit by hand: the
